# Compiler options
CC = gcc
CFLAGS = -Wall -Wextra -Iclient/include -Iserver/include -IlibUtils -pthread
LDFLAGS = -pthread
...
$(CLIENT_EXECUTABLE): $(CLIENT_OBJS) $(LIBUTILS_OBJS)
	$(CC) $(CFLAGS) $(LDFLAGS) $^ -o $@

$(SERVER_EXECUTABLE): $(SERVER_OBJS) $(LIBUTILS_OBJS)
	$(CC) $(CFLAGS) $(LDFLAGS) $^ -o $@
